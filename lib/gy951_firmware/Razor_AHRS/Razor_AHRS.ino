...
#define MAGN_X_MIN ((float) -124)
#define MAGN_X_MAX ((float) 138)
#define MAGN_Y_MIN ((float) -125)
#define MAGN_Y_MAX ((float) 139)
#define MAGN_Z_MIN ((float) -180)
#define MAGN_Z_MAX ((float) 73)
...
#define GYRO_AVERAGE_OFFSET_X ((float) 22.53)
#define GYRO_AVERAGE_OFFSET_Y ((float) 14.64)
#define GYRO_AVERAGE_OFFSET_Z ((float) -6.89)
