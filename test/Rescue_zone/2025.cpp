            ...
            { // robot is currently not performing any task
                ...
                case 2:
                    ...
                    if(left_distance < right_distance)
                    {
                        ...
                        runTime(50,BACKWARD,0,1500);
                        runAngle(20,FORWARD,-45);
                    }
                    else
                    {
                        runAngle(20,FORWARD,-90);
                        runTime(15,BACKWARD,0,500);
                        runAngle(20,FORWARD,45);
                ...
                case 7: // linetrack
                    ...
                    {int velocidadAjustada = ajustarVelocidadPorPendiente(30);
        ...
        while (rutina == "rescate" && digitalRead(32) == 0)
        {
           digitalWrite(LED_BUILTIN, HIGH);
            ...
            if (green_state == 5)
            {
                ...
                else if (green_state == 12)
                {
                    runTime(0,FORWARD,0,1000);
                }
                rutina = "depositar";
                runAngle(30,FORWARD,angulo_rescate);
                leer_ultrasonidos();
