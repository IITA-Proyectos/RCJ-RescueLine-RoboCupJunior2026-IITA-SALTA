...
while True:
    ...
    if debugGreen:
        cv2.imshow('Green Mask', green_mask)
    ### NUEVA PARTE: DETECCIÓN Y DIBUJO DE CONTORNOS VERDES #
    if cv2.waitKey(1) & 0xFF == ord('q'):
        break
# Agregar la validación de los contornos detectados para confi

# Mostrar la imagen actualizada con los recuadros
